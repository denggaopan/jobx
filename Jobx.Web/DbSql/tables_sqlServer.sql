...
CREATE TABLE [dbo].[QRTZ_JOB_GROUP] (
  [JOB_GROUP_NAME] [NVARCHAR] (120)  NOT NULL ,
  [DESCRIPTION] [NVARCHAR] (250)  NULL ,
  [IS_ENABLE] BIT  NOT NULL 
)
GO

CREATE TABLE [dbo].[QRTZ_JOB_EXECUTION_LOG](
	[ID] [int] IDENTITY(1,1) NOT NULL,
	[JOB_NAME] [nvarchar](150) NOT NULL,
	[JOB_GROUP] [nvarchar](150) NOT NULL,
	[EXECUTION_STATUS] [int] NOT NULL,
	[REQUEST_URL] [nvarchar](150) NOT NULL,
	[REQUEST_TYPE] [nvarchar](150) NOT NULL,
	[HEADERS] [nvarchar](max) NULL,
	[REQUEST_DATA] [nvarchar](max) NULL,
	[RESPONSE_DATA] [nvarchar](max) NULL,
	[BEGIN_TIME] [nvarchar](150) NULL,
 CONSTRAINT [PK_QRTZ_JOB_EXECUTION_LOG] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
...
CREATE INDEX IDX_QRTZ_JEL_TG ON QRTZ_JOB_EXECUTION_LOG(JOB_NAME,JOB_GROUP)
GO
