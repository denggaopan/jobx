...
namespace Jobx.Web.Controllers
{
    /// <summary>
    /// 任务调度
    /// </summary>
    ...
    public class JobController : Controller
    {
        ...
        public async Task<BaseResult> AddJob([FromBody] ScheduleEntity entity)
        {
            ...
            return await scheduler.AddScheduleJobAsync(entity, 0);
        }
        ...
        public async Task<BaseResult> ModifyJob([FromBody] ModifyJobInput entity)
        {
            ...
            await scheduler.AddScheduleJobAsync(entity.NewScheduleEntity, 1, runNumber);
