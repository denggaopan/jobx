    ...
    public class SchedulerCenter
    {
        ...
        private async Task InitSchedulerAsync()
        {
            if (scheduler == null)
            {
                ...
                DirectSchedulerFactory.Instance.CreateScheduler("Scheduler1", "AUTO", new DefaultThreadPool(), jobStore);
                scheduler = await SchedulerRepository.Instance.Lookup("Scheduler1");
            }
        }
